                            ...
                            <div class="author-content"> <h3 class="author-name h1"><?php the_title();?><?php do_action('videopro_after_title', get_the_ID() );?></h3>
                              ...
                              <ul class="social-listing list-inline">
                                  ...
                                  if($imdb = get_post_meta(get_the_ID(),'imdb',true)){ ?>
									  <li class="imdb"><a rel="nofollow" href="<?php echo esc_url($imdb); ?>" title="<?php esc_html_e('IMDB', '17jbh');?>"><i class="fa fa-imdb"></i></a></li>
								  <?php }
                                  
								  if($facebook = get_post_meta(get_the_ID(),'facebook',true)){ ?>
									  <li class="facebook"><a rel="nofollow" href="<?php echo esc_url($facebook); ?>" title="<?php esc_html_e('Facebook', '17jbh');?>"><i class="fa fa-facebook"></i></a></li>
								  <?php }
								  if($twitter = get_post_meta(get_the_ID(),'twitter',true)){ ?>
									  <li class="twitter"><a rel="nofollow" href="<?php echo esc_url($twitter); ?>" title="<?php esc_html_e('Twitter', '17jbh');?>"><i class="fa fa-twitter"></i></a></li>
								  <?php }
								  if($linkedin = get_post_meta(get_the_ID(),'linkedin',true)){ ?>
									  <li class="linkedin"><a rel="nofollow" href="<?php echo esc_url($linkedin); ?>" title="<?php esc_html_e('Linkedin', '17jbh');?>"><i class="fa fa-linkedin"></i></a></li>
								  <?php }
								  if($tumblr = get_post_meta(get_the_ID(),'tumblr',true)){ ?>
									  <li class="tumblr"><a rel="nofollow" href="<?php echo esc_url($tumblr); ?>" title="<?php esc_html_e('Tumblr', '17jbh');?>"><i class="fa fa-tumblr"></i></a></li>
								  <?php }
								  if($google = get_post_meta(get_the_ID(),'google-plus',true)){ ?>
									 <li class="google-plus"> <a rel="nofollow" href="<?php echo esc_url($google); ?>" title="<?php esc_html_e('Google Plus', '17jbh');?>"><i class="fa fa-google-plus"></i></a></li>
								  <?php }
								  if($pinterest = get_post_meta(get_the_ID(),'pinterest',true)){ ?>
									 <li class="pinterest"> <a rel="nofollow" href="<?php echo esc_url($pinterest); ?>" title="<?php esc_html_e('Pinterest', '17jbh');?>"><i class="fa fa-pinterest"></i></a></li>
								  <?php }
								  if($instagram = get_post_meta(get_the_ID(),'instagram',true)){ ?>
									 <li class="instagram"> <a rel="nofollow" href="<?php echo esc_url($instagram); ?>" title="<?php esc_html_e('Instagram', '17jbh');?>"><i class="fa fa-instagram"></i></a></li>
								  <?php }
								  if($flickr = get_post_meta(get_the_ID(),'flickr',true)){ ?>
									 <li class="flickr"> <a rel="nofollow" href="<?php echo esc_url($flickr); ?>" title="<?php esc_html_e('Flickr', '17jbh');?>"><i class="fa fa-flickr"></i></a></li>
								  <?php }
								  if($youtube = get_post_meta(get_the_ID(),'youtube',true)){ ?>
									 <li class="youtube"> <a rel="nofollow" href="<?php echo esc_url($youtube); ?>" title="<?php esc_html_e('Youtube', '17jbh');?>"><i class="fa fa-youtube"></i></a></li>
								  <?php }
                                  
                                  if($email = get_post_meta(get_the_ID(),'envelope',true)){ ?>
									  <li class="email"><a rel="nofollow" href="mailto:<?php echo esc_attr($email); ?>" title="<?php esc_html_e('Email', '17jbh');?>"><i class="fa fa-envelope-o"></i></a></li>
								  <?php }
                                  
								  if($github = get_post_meta(get_the_ID(),'github',true)){ ?>
									 <li class="github"> <a rel="nofollow" href="<?php echo esc_url($github); ?>" title="<?php esc_html_e('Github', '17jbh');?>"><i class="fa fa-github"></i></a></li>
								  <?php }
								   if($dribbble = get_post_meta(get_the_ID(),'dribbble',true)){ ?>
									 <li class="dribbble"> <a rel="nofollow" href="<?php echo esc_url($dribbble); ?>" title="<?php esc_html_e('Dribbble', '17jbh');?>"><i class="fa fa-dribbble"></i></a></li>
								  <?php }
								  if($vk = get_post_meta(get_the_ID(),'vk',true)){ ?>
									 <li class="vk"> <a rel="nofollow" href="<?php echo esc_url($vk); ?>" title="<?php esc_html_e('vk', '17jbh');?>"><i class="fa fa-vk"></i></a></li>
								  <?php }
