...
$text_translate_actor_st = esc_html__('General','17jbh');
...
class Cactus_Actor{
	...
	function register_page_templates(){
		...
		$page_templ = array('cactus-actor/includes/page-templates/actor-listing.php' => esc_html__('Actor Listing Page', '17jbh'));
	...
	function register_configuration(){
		...
		$ct_actor_settings = new Options_Page('ct_actor_settings', array('option_file'=>dirname(__FILE__) . '/options.xml','menu_title'=>esc_html__('Actor Settings','17jbh'),'menu_position'=>null), array('page_title'=>esc_html__('Actor Setting Page','17jbh'),'submit_text'=>esc_html__('Save','17jbh')));
	}
	...
	function register_ct_actor(){
				$labels = array(
			'name'               => esc_html__('Actor', '17jbh'),
			'singular_name'      => esc_html__('Actor', '17jbh'),
			'add_new'            => esc_html__('Add New Actor', '17jbh'),
			'add_new_item'       => esc_html__('Add New Actor', '17jbh'),
			'edit_item'          => esc_html__('Edit Actor', '17jbh'),
			'new_item'           => esc_html__('New Actor', '17jbh'),
			'all_items'          => esc_html__('All Actors', '17jbh'),
			'view_item'          => esc_html__('View Actor', '17jbh'),
			'search_items'       => esc_html__('Search Actor', '17jbh'),
			'not_found'          => esc_html__('No Actor found', '17jbh'),
			'not_found_in_trash' => esc_html__('No Actor found in Trash', '17jbh'),
			'parent_item_colon'  => '',
			'menu_name'          => esc_html__('Video Actor', '17jbh'),
		  );
		...
		$cat_labels = array(
			'name'=> esc_html__('Tags','17jbh'),
			'singular_name'=>esc_html__('Tags','17jbh')
		);
	...
	function register_post_type_metadata(array $meta_boxes){
		$actor_id = array(
				array( 'id' => 'actor_id', 'name' => esc_html__('Actor','17jbh'), 'type' => 'post_select', 'use_ajax' => true, 'query' => array( 'post_type' => 'ct_actor' ), 'multiple' => true,  'desc' => esc_html__('Add Actors to this video','17jbh'),  'repeatable' => false),
                array( 'id' => 'new_actor', 'name' => esc_html__('Add New Actor', '17jbh'), 'type' => 'text','desc' => esc_html__('Enter Actor Name here, separate names with a comma. New Actor will be created if a same name is not found', '17jbh') , 'repeatable' => false, 'multiple' => false ),
		);

		$meta_boxes[] = array(
			'title' => esc_html__('Video Actors','17jbh'),
			'pages' => 'post',
			'fields' => $actor_id,
			'priority' => 'high'
		);
		...
		$ct_actor_birthday = array(
			array( 'id' => 'actor_bt_day',  'name' => esc_html__('Day','17jbh'), 'cols' => 2, 'type' => 'select', 'options' => $day_arr , 'allow_none' => true, 'sortable' => false, 'repeatable' => false ),
			array( 'id' => 'actor_bt_month',  'name' => esc_html__('Month','17jbh'), 'cols' => 2, 'type' => 'select', 'options' => $month_arr , 'allow_none' => true, 'sortable' => false, 'repeatable' => false ),
			array( 'id' => 'actor_bt_year',  'name' => esc_html__('Year','17jbh'), 'type' => 'text', 'cols' => 2 ),
		);
		$meta_boxes[] = array(
			'title' => esc_html__('Actor Birthday','17jbh'),
			'pages' => 'ct_actor',
         ...
         $custom_account_fields = array(
                            array( 'id' => 'actor-custom_account-name', 'name' => __('Account Name:', '17jbh'), 'type' => 'text','desc' => __('Name of Social Account', '17jbh')),
                            array( 'id' => 'actor-custom_account-css_class', 'name' => __('Account Icon:', '17jbh'), 'type' => 'text','desc' => __('CSS Class Name of Social Account Icon', '17jbh')),
                            array( 'id' => 'actor-custom_account-link', 'name' => __('Account Link:', '17jbh'), 'type' => 'text','desc' => __('URL of Social Account', '17jbh')),
                        );
                        
		$ct_actor_fields2 = array(
                array(
                    'id' => 'is_verified',
                    'name' => esc_html__('Is Verified Actor?', '17jbh'),
                    'type' => 'select',
                    'options' => array(
				...
				array( 'id' => 'actor-pos', 'name' => __('Position:', '17jbh'), 'type' => 'text','desc' => __('Position/Title of actor', '17jbh') , 'repeatable' => false, 'multiple' => false ),
				array( 'id' => 'website', 'name' => __('Website:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),
                array( 'id' => 'facebook', 'name' => __('Facebook:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),
				array( 'id' => 'instagram', 'name' => __('Instagram:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),	
                array( 'id' => 'imdb', 'name' => __('IMDB:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),
				array( 'id' => 'twitter', 'name' => __('Twitter:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),
				array( 'id' => 'linkedin', 'name' => __('LinkedIn:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false),	
				array( 'id' => 'tumblr', 'name' => __('Tumblr:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),	
				array( 'id' => 'google-plus', 'name' => __('Google Plus:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),
				array( 'id' => 'pinterest', 'name' => __('Pinterest:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh') , 'repeatable' => false, 'multiple' => false),	
				array( 'id' => 'youtube', 'name' => __('YouTube:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),	
				array( 'id' => 'flickr', 'name' => __('Flickr:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh') , 'repeatable' => false, 'multiple' => false),
                array( 'id' => 'envelope', 'name' => __('Email:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter email contact of actor', '17jbh'), 'repeatable' => false, 'multiple' => false ),                
				array( 'id' => 'github', 'name' => __('GitHub:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh'), 'repeatable' => false, 'multiple' => false ),	
				array( 'id' => 'dribbble', 'name' => __('Dribbble:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh') , 'repeatable' => false, 'multiple' => false),
				array( 'id' => 'vk', 'name' => __('VK:', '17jbh'), 'type' => 'text' ,'desc' => __('Enter full link to actor profile page', '17jbh') , 'repeatable' => false, 'multiple' => false),
                array(
                    'id' => 'actor-custom_account',
                    'name' => __('Custom Social Accounts', '17jbh'),
                    'type' => 'group',
                    'repeatable' => true,
                    'sortable' => true,
                    'fields' => $custom_account_fields,
                    'desc' => __('Custom Social Accounts', '17jbh')
                )
			);

		$meta_boxes[] = array(
			'title' => esc_html__('Actor Info','17jbh'),
			'pages' => 'ct_actor',
