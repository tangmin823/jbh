            ...
            <div class="cactus-row">
                ...
                <div class="main-content-col">
                    <div class="main-content-col-body">
                		...
                		<h1 class="castings-title category-title entry-title"><?php if(is_page()){the_title();} else{ esc_html_e('Actors','17jbh');}?></h1>
                        <?php 
                        $query_string = '';
                        global $wp;
                        ...
                        <div class="alphabet-filter">
                            <a class="font-size-1 ct-gradient metadata-font <?php echo isset($_GET['orderby'])?'':'active' ?>" href="<?php echo esc_url(remove_query_arg('orderby', $current_url)); ?>"><?php esc_html_e('All','17jbh'); ?></a>
                                <?php 
                        ...
                        <?php } else{
							?>
                            <p><?php esc_html_e('There isn\'t any Actors in this category', '17jbh');?></p>
                            <?php
						}
						wp_reset_postdata();
                        if($it>0){
