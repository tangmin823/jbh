		...
		'counter'     => apply_filters(
			'tptn_settings_counter', array(
				...
				'count_disp_form'       => array(
					...
					'desc'    => sprintf( esc_html__( 'Use %1$s to display the total count, %2$s for daily count and %3$s for overall counts across all posts. Default display is %4$s', 'top-10' ), '<code>%totalcount%</code>', '<code>%dailycount%</code>', '<code>%overallcount%</code>', '<code>(总阅读量 %totalcount%, 今日阅读量 %dailycount%)</code>' ),
					'type'    => 'textarea',
					'options' => '(总阅读量 %totalcount%, 今日阅读量 %dailycount%)',
				),
