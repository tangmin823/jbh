...
class easy_tab_widget extends WP_Widget {
	...
	function __construct() {
    	$widget_ops = array(
			...
			'description' => esc_html__('Displays widgets in a tab','17jbh')
		);
    	parent::__construct('easy_tab_widget', esc_html__('Easy Tab Widget','17jbh'), $widget_ops);
	}
...
class easy_tab_widget_divider extends WP_Widget{
	...
	function __construct() {
    	$widget_ops = array(
			...
			'description' => esc_html__('Divide widgets into tabs. Used for Easy Tab Widget','17jbh')
		);
    	parent::__construct('easytabdivider', esc_html__('Easy Tab Divider','17jbh'), $widget_ops);
	}
