...
function tm_mtl_inner_custom_box() {
    ...
    <tr><td width="240"><strong><?php esc_html_e('Group Title','17jbh');?></strong></td>
    <td><strong><?php esc_html_e('Links','17jbh');?></strong></td>
    <td></td></tr>
    <?php
    ...
    if ( $links && count( $links ) > 0 ) {
		...
		<tr>
            <td><?php echo wp_kses(__( '<i>Click Add Group to start</i>','17jbh'),array('i'=>array())); ?></td>
            <td></td>
        </tr>
	<?php }
    ...
    <table cellpadding="4">
    <tr>
        <td width="240" valign="top"><button class="add_tm_link button-primary button-large"><i class="fa fa-plus"></i> <?php esc_html_e('Add Group', '17jbh'); ?></button></td>
        <td><?php echo wp_kses(__( '<i>Paste your videos link (and title) here. Enter one per line.<br/> For Example:<br/> <code>Trailer 1</code><br/><code>http://www.youtube.com/watch?v=nTDNLUzjkpg</code><br/><code>Trailer 2</code><br/><code>http://www.youtube.com/watch?v=nTDNLUzjkpg</code><br> You could enter links without title</i>','17jbh'),array('br'=>array()),array('strong'=>array()),array('code'=>array()));?></td>
    </tr>
    </table>
<script>
...
if(!function_exists('videopro_query_morevideo')){
	...
	function videopro_query_morevideo($id_curr, $query_by, $post_format, $number, $video_load = false, $date = false){
        ...
        if(!$video_load){
            ...
            if (!is_array($args['date_query'])) $args['date_query'] = array();
            $args['date_query']['after'] = $date;
