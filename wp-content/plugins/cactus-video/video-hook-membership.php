          ...
          <div class="modal-dialog">        	
            <div class="modal-content">              
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="videopro_upload_videos_form_heading"><?php esc_html_e('Upload Video','17jbh'); ?></h4>
              </div>
              <div class="modal-body">
                  ...
                  if ($form_id_cf7 != '') {
                      ...
                      $value = apply_filters( 'videopro_upload_video_form_in_channel', esc_html__('Please go to Theme Options > Membership > Upload Videos In Channel Form to specify a Form ID', '17jbh') );
                      echo $value;
                  }
                  ?>
              </div>
            ...
            <div class="modal-content">              
              ...
              <div class="modal-body">
                ...
                if ($form_id_cf7 != '') {
                    ...
                    $value = apply_filters( 'videopro_upload_video_form_in_playlist', esc_html__('Please go to Theme Options > Membership > Upload Videos In Playlist Form to specify a Form ID','17jbh') );
                    echo $value;
                }
				?>
              </div>
        ...
        <div class="submitModal modal fade" id="videopro_edit_playlist_form">         
          <div class="modal-dialog">        	
            <div class="modal-content">              
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="videopro_edit_playlist_form_heading"><?php esc_html_e('Edit Playlist','17jbh'); ?></h4>
              </div>
              <div class="modal-body">
                <div id="video-edit-playlist-form" class="edit-thumbnail-form">
                    <form enctype="multipart/form-data" method="post">
                        <div class="content">
                        <p><label><?php echo esc_html__('Playlist Title:','17jbh');?></label></p>
                        <p><input type="text" required="true" name="title" value="<?php echo get_the_title();?>"></p>
                        <p><label><?php echo esc_html__('Playlist Thumbnail:','17jbh');?></label></p>
                        ...
                        <input type="submit" name="submit" class="btn-default bt-style-1" value="<?php echo esc_html__('Save','17jbh');?>"/>
                        <a href="#" data-back="<?php echo esc_url(get_author_posts_url(get_post_field('post_author', get_the_ID())));?>" class="btn-remove-post" data-title="<?php echo esc_attr(get_the_title());?>" data-id="<?php echo esc_attr(get_the_ID());?>" data-type="ct_playlist"><?php echo esc_html__('Delete','17jbh');?></a><img class="ajax-loader" src="<?php echo esc_url(get_template_directory_uri());?>/images/ajax-loader.gif" alt="Sending ..." style="display:none">
                        </div>
                        <div class="thumbnail">
                            <p><label><?php echo esc_html__('Current Thumbnail:','17jbh');?></label></p>
                            <?php if(has_post_thumbnail()){?>
                            <p>
                            <?php echo get_the_post_thumbnail();?>
                            </p>
                            <?php } else {
                                esc_html_e('Not available yet','17jbh');
                            }
                            ?>
                        </div>
            ...
            <div class="submitModal modal fade" id="videopro_edit_channel_form">         
              <div class="modal-dialog">        	
                <div class="modal-content">              
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="videopro_edit_channel_form_heading"><?php esc_html_e('Edit Channel','17jbh'); ?></h4>
                  </div>
                  <div class="modal-body">
                    <div id="video-edit-channel-form" class="edit-thumbnail-form">
                        <form enctype="multipart/form-data" method="post">
                            <div class="content">
                                <p><label><?php echo esc_html__('Channel Title:','17jbh');?></label></p>
                                <p><input type="text" required="true" name="title" value="<?php echo get_the_title();?>"></p>
                                <p><label><?php echo esc_html__('Channel Thumbnail:','17jbh');?></label></p>
                                <p><input type="file" name="thumbnail"></p>
            ...
            <div class="submitModal modal fade videopro_popup" id="videopro_user_create_channel_popup">         
              <div class="modal-dialog">        	
                <div class="modal-content">              
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="videopro_user_create_channel_popup_heading"><?php esc_html_e('Create a new channel','17jbh'); ?></h4>
                  </div>
                  <div class="modal-body textwidget">
                    <form class="wpcf7">
                        <?php do_action('videopro_before_user_create_channel_form');?>
                        <p><label class="row"><?php esc_html_e('Name your channel (*)','17jbh'); ?></label>
                        ...
                        <span class="hidden message"><?php esc_html_e('Please enter a name','17jbh');?></span>
                        </p>
                        <?php
                        $categories = get_terms('channel_cat', array('hide_empty' => false, 'orderby' => 'id'));
                        if(count($categories) > 0){?>
                        <p><label class="row"><?php esc_html_e('Category','17jbh'); ?></label>
                        <span class="wpcf7-form-control-wrap menu-451"><select name="select_category" class="wpcf7-form-control wpcf7-select"><option value=""><?php esc_html_e('Select a Category','17jbh'); ?></option>
                        <?php 
                        ...
                        <span class="hidden message"><?php esc_html_e('You are required to agree the terms','17jbh');?></span>
                        <p>
                        <?php }
                        ...
                        <input type="submit" value="<?php echo esc_html__('SUBMIT', '17jbh');?>" class="wpcf7-form-control wpcf7-submit">
                        <img class="ajax-loader" src="<?php echo get_template_directory_uri(); ?>/images/ajax-loader.gif" alt="<?php echo esc_html__('Sending ...', '17jbh');?>" style="visibility: hidden;">
                        </p>
            ...
            <div class="submitModal modal fade videopro_popup" id="videopro_user_create_playlist_popup">         
              <div class="modal-dialog">        	
                <div class="modal-content">              
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="videopro_user_create_channel_popup_heading"><?php esc_html_e('Create a new playlist','17jbh'); ?></h4>
                  </div>
                  <div class="modal-body textwidget">
                    <form class="wpcf7">
                        <?php do_action('videopro_before_user_create_playlist_form');?>
                        <p><label class="row"><?php esc_html_e('Name your playlist','17jbh'); ?></label>
                        ...
                        <input type="submit" value="<?php esc_html_e('SUBMIT', '17jbh');?>" class="wpcf7-form-control wpcf7-submit">
                        <img class="ajax-loader" src="<?php echo get_template_directory_uri(); ?>/images/ajax-loader.gif" alt="<?php esc_html_e('Sending ...', '17jbh');?>" style="visibility: hidden;">
                        </p>
    ...
    function videopro_add_edit_video_button_to_player($context = ''){
        if(is_single()){            
            if(videopro_current_user_can('video.edit', array('id' => get_the_ID()))){
                ?>
                <a href="<?php echo Cactus_video::get_edit_video_url(get_the_ID());?>" id="btn-upload-video-thumb" alt="<?php esc_html_e('Edit Video','17jbh');?>" class="btn-edit-video-thumbnail"><?php videopro_edit_button_icon();?></a>
                <?php
            }
        }
    }
                    ...
                    if($options['channel-limit'] > 0){
                        ...
                        if($has_limited_membership){
                            ...
                            if($count_created_channels < $options['channel-limit']){
                                ...
                                if($show_message){
                                    echo apply_filters('videopro_membership_limit_create_channel_message', esc_html__('You have reached your limit to create channel', '17jbh'));
                                }
                            }
                        }
                    } else {
                        ...
                        if($options['playlist-limit'] > 0){
                            ...
                            if($has_limited_membership){
                                ...
                                if($count_created_playlists < $options['playlist-limit']){
                                    ...
                                    if($show_message){
                                        echo apply_filters('videopro_membership_limit_create_playlist_message', esc_html__('You have reached your limit to create playlist', '17jbh'));
                                    }
                                }
                            }
                        } else {
                            ...
                            if($has_limited_membership){
                                ...
                                if($count_uploaded_videos < $options['video-limit']){
                                    ...
                                    if($show_message){
                                        ...
                                        echo apply_filters('videopro_membership_limit_upload_video_message', esc_html__('You have reached your limit to upload video', '17jbh'));
                                    }
                                }
                            }
                        } else {
