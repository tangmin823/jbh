			...
			<div class="picture-content">
				...
				<div class="cactus-tooltip dark-div">
					...
					<div class="tooltip-info">
                        ...
                        <?php }?>
						<span><i class="fa fa-play-circle"></i> <span><?php echo $term->count > 1 ? sprintf(esc_html__('%d VIDEOS', '17jbh'),$term->count) : sprintf(esc_html__('%d VIDEO', '17jbh'), $term->count);?></span></span>
