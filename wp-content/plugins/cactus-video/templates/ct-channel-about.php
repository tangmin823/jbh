...
<div class="about-information">
    ...
    ?>                                       	
    <div><i class="fa fa-play-circle"></i><span><?php echo $n_video; esc_html_e(' videos','17jbh'); ?></span></div>
    <div><i class="fa fa-users"></i><span><?php echo $subscribe_counter; esc_html_e(' subscribers ','17jbh'); ?></span></div>
    <div><i class="fa fa-eye"></i><span><?php echo $view_channel; esc_html_e(' views','17jbh'); ?></span></div>
</div>
