					...
					<div class="main-content-col-body">
						<div class="single-post-content">
							<article class="cactus-single-content">
									...
									<div class="left">
										<div class="posted-on metadata-font">
											...
											<div class="cactus-info font-size-1">
												<span><?php echo sprintf(esc_html__('%d Videos', '17jbh'), $wp_query->found_posts); ?></span>
											</div>                                                                                                     
										</div>
										<?php if($video_series_creator!=''){?>
										<div class="posted-on metadata-font right">
											<div class="creator-elm cactus-info font-size-1">
												<span><?php echo esc_html__('Creator: ','17jbh').esc_html($video_series_creator);?></span>
											</div>                                         
										</div>
                                        <?php }?>
										<?php
								...
								<h2 class="h4 title-cat"><?php echo esc_html__('Stars','17jbh');?></h2>
                                            ...
                                            <div class="channel-subscribe">
                                                ...
                                                <div class="channel-content">
                                                    ...
                                                    <div class="channel-button">                                                                
                                                        <span class="font-size-1 metadata-font sub-count"><?php echo sprintf(esc_html__('%d Videos', '17jbh'), $it); ?></span>
                                                    </div>
                                                </div>
