            ...
            <div class="cactus-row">
                ...
                <div class="main-content-col">
                    <div class="main-content-col-body">
                        <h1 class="single-title entry-title"><?php echo esc_html_e('EDIT: ','17jbh');?><?php echo $the_post->post_title;?></h1>
                        <form enctype="multipart/form-data" method="post" class="video-edit">
                            <div id="the_player">
                                ...
                                <div id="the_thumbnail">
                                    <h5><?php echo esc_html__('Video Thumbnail', '17jbh');?></h5>
                            ...
                            <p><label><span class="title"><?php echo esc_html__('Video Title:', '17jbh');?></span> <input type="text" required="true" name="title" value="<?php echo $the_post->post_title;?>"></label></p>
                            <p><label><span class="title"><?php echo esc_html__('Video Summary:', '17jbh');?></span> <textarea name="excerpt" cols="20" rows="10"><?php echo $the_post->post_excerpt;?></textarea></label></p>
                            <p><label><span class="title"><?php echo esc_html__('Video Description:', '17jbh');?></span> <textarea name="description" cols="20" rows="10"><?php echo $the_post->post_content;?></textarea></label></p>
                            <?php
                            
                            $allow = ot_get_option('membership_allow_edit_video_cats_tags','on');
                            if($allow == 'on'){?>
                            <p><label><span class="title"><?php echo esc_html__('Video Categories:', '17jbh');?></span></label><br/> 
                            ...
                            <label><span class="title"><?php echo esc_html__('Video Tags: ','17jbh');?></span> <input type="text" name="tags" value="<?php echo implode(', ', $tags);?>"/></label>
                            </p>
                            <?php }?>
                            <?php
                            ...
                            if($query->have_posts()){
                                ?>
                                <p><label><span class="title"><?php echo esc_html__('Video Playlist:', '17jbh');?></span></label><br/> 
                                <?php
                            ...
                            if($query->have_posts()){
                                ?>
                                <p><label><span class="title"><?php echo esc_html__('Video Channel:', '17jbh');?></span></label><br/> 
                                <?php
                            ...
                            <input type="button" name="cancel" onclick="location.href='<?php echo esc_url($back_url);?>';return false;" class="btn-default" value="<?php echo esc_html__('Back', '17jbh');?>"/> <input type="submit" name="submit" class="btn-default bt-style-1" value="<?php echo esc_html__('Save changes', '17jbh');?>"/>
                            </p>
                        </form>
                    </div>
                </div>
