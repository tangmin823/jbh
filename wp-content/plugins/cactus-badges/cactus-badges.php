...
if(!class_exists('Cactus_badges')){	
	class Cactus_badges{
		...
		function register_badges_taxonomies(){
			$badges_label = array(
				'name'              => esc_html__( 'Badges', '17jbh' ),
				'singular_name'     => esc_html__( 'Badges', '17jbh' ),
				'search_items'      => esc_html__( 'Search','17jbh' ),
				'all_items'         => esc_html__( 'All Badges','17jbh' ),
				'parent_item'       => esc_html__( 'Parent Badges' ,'17jbh'),
				'parent_item_colon' => esc_html__( 'Parent Badges:','17jbh' ),
				'edit_item'         => esc_html__( 'Edit Badge' ,'17jbh'),
				'update_item'       => esc_html__( 'Update Badge','17jbh' ),
				'add_new_item'      => esc_html__( 'Add New Badge' ,'17jbh'),
