...
class Swarmify_Admin {
	...
	public function option_page(){
		add_options_page('SmartVideo','SmartVideo','manage_options',$this->plugin_name.'.php',array($this, 'option_display'));
	}
    ...
    public function add_video_button() {
        echo '<a href="javascript:;" data-fancybox data-src="#swarmify-modal-content" class="button swarmify_add_button"><img src="'.plugin_dir_url(__FILE__).'images/smartvideo_icon.png" alt="">Add SmartVideo</a>';
    }
