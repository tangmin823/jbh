                                ...
                                <div class="cactus-listing-config style-3"> <!--addClass: style-1 + (style-2 -> style-n)-->
                                    <div class="cactus-sub-wrap">
										...
										while($the_query->have_posts()):$the_query->the_post();
											...
											$i++;?> 
                                            <article class="cactus-post-item<?php if($i==1){?> active<?php }?>">
                                                ...
                                                <div class="entry-content">                                        
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="posted-on metadata-font">                                                            	
                                                            <?php if($viewed!=''){?><span class="fa fa-eye cactus-info font-size-1"><?php echo sprintf(esc_html__(' %s 阅读','17jbh'), $viewed);?></span><?php }?>
                                                        </div>
