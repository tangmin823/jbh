...
?>
    <div class="c_authors authors-listing-content">
        ...
        <?php if($view_all_url != ''){?>
        <p class="viewall"><a href="<?php echo esc_url($view_all_url);?>" class="btn btn-default ct-gradient bt-action metadata-font font-size-1"><?php echo esc_html__('See All Authors...', '17jbh');?></a></p>
        <?php
        }
    ?>
    </div><!-- end .c_authors /-->
...
function videopro_reg_ct_authors(){
    ...
    vc_map( 	array(
			   "name" => esc_html__("VideoPro Authors",'17jbh'),
			   "base" => "c_authors",
			   "class" => "",
			   "icon" => "icon-authors",
			   "controls" => "full",
			   ...
			   "params" => 	array(
					...
					array(
					   "type" => "dropdown",
					   "class" => "",
					   "heading" => esc_html__("Column Width", '17jbh'),
					   "param_name" => "width",
					   "value" => array(
                                '12/12' => 12,
                                '6/12' => 6,
					   ...
					   "description" => esc_html__('Choose column width', '17jbh'),
					),
					array(
					   "type" => "textfield",
					   "class" => "",
					   "heading" => esc_html__("Author IDs", '17jbh'),
					   "param_name" => "authors",
					   "value" => '',
					   "description" => esc_html__('Enter list of Author IDs (separated by a comma) if you want to list only those authors', '17jbh'),
					)
				)
			));
    }
