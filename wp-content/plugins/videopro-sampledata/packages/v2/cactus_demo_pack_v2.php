 ...
 * 
 */
class cactus_demo_pack_v2 extends cactus_demo_content {
	...
	function do_others($step, $index){
		if($step == 10 || $step == 90){
            ...
            $actor_settings = file_get_contents(dirname(__FILE__) . '/data/actor-settings.txt');
            ...
            update_option('ct_actor_settings', $actor_settings);
		} elseif($step == 0){
			// import metadata
	...
	public function configure_widget_options($widget_settings, $widget_index_mapping){
		cactus_import_widget_settings::set_widget_options('right-sidebar', 0, 'cactusthemes_style', 'style-4');
		cactus_import_widget_settings::set_widget_options('right-sidebar', 0, 'cactusthemes', 'small-padding dark-div');
        
        cactus_import_widget_settings::set_widget_options('right-sidebar', 1, 'cactusthemes_style', 'style-2');
        
        cactus_import_widget_settings::set_widget_options('right-sidebar', 2, 'cactusthemes_style', 'style-5');
        
        cactus_import_widget_settings::set_widget_options('right-sidebar', 3, 'cactusthemes_style', 'style-4');
        cactus_import_widget_settings::set_widget_options('right-sidebar', 3, 'cactusthemes', 'small-padding white-div');
        
        cactus_import_widget_settings::set_widget_options('right-sidebar', 4, 'cactusthemes_style', 'style-5');
        
        cactus_import_widget_settings::set_widget_options('right-sidebar', 6, 'cactusthemes_style', 'style-2');
        
        cactus_import_widget_settings::set_widget_options('right-sidebar', 7, 'cactusthemes_style', 'style-3');        
        cactus_import_widget_settings::set_widget_options('right-sidebar', 7, 'cactusthemes', 'dark-div');
        
        cactus_import_widget_settings::set_widget_options('main-bottom-sidebar', 0, 'cactusthemes', 'dark-div');
	}
}