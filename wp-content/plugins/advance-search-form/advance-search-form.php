...
?>	
		...
		if(isset($_POST['orderby']) && $_POST['orderby'] != ''){?>			
			<?php
				...
				if($orderby == 'date'){
                    $activeFilterItems.= '<a href="javascript:;" data-source="date" data-type="orderby">'.esc_html__('Published Date', '17jbh').' (x)</a>';
                }elseif($orderby == 'view'){
					$activeFilterItems.= '<a href="javascript:;" data-source="view" data-type="orderby">'.esc_html__('Most Viewed', '17jbh').' (x)</a>';
				}elseif($orderby == 'like'){
					$activeFilterItems.= '<a href="javascript:;" data-source="like" data-type="orderby">'.esc_html__('Most Liked', '17jbh').' (x)</a>';
				}elseif($orderby == 'comments'){
					$activeFilterItems.= '<a href="javascript:;" data-source="comments" data-type="orderby">'.esc_html__('Most Commented', '17jbh').' (x)</a>';
				}elseif($orderby == 'title'){
					$activeFilterItems.= '<a href="javascript:;" data-source="title" data-type="orderby">'.esc_html__('Title', '17jbh').' (x)</a>';
				}
            ?>			
		<?php }?>
		...
		if(isset($_POST['order']) && $_POST['order'] != ''){?>			
			<?php
                $order = $_POST['order'];
				if($order == 'DESC'){
                    $activeFilterItems.= '<a href="javascript:;" data-source="DESC" data-type="order">'.esc_html__('Descending', '17jbh').' (x)</a>';
                }elseif($order == 'ASC'){
					$activeFilterItems.= '<a href="javascript:;" data-source="ASC" data-type="order">'.esc_html__('Ascending', '17jbh').' (x)</a>';
				}
            ?>			
		<?php }?>
		...
		if(isset($_POST['length']) && $_POST['length'] != 0){?>			
			<?php
				...
				$dur = '';
                if($length <= 4){
                    $str = esc_html__('Short (&lt; 4 mins)','17jbh');
					$dur = '4';
                } elseif($length <= 20){
                    $str = esc_html__('Medium (&lt; 20 mins)','17jbh');
					$dur = '20';
                } else{
                    $str = esc_html__('Long (&gt; 20 mins)','17jbh');
					$dur = '10000';
                }
		...
		if(!empty($all_categories)){?>
            <p class="filter-item categories-items">
                <span class="filter-heading"><?php echo esc_html__('Categories: ', '17jbh');?></span>            
                <?php
		...
		<p class="filter-item orderby-items">
			<span class="filter-heading"><?php echo esc_html__('Sort By: ', '17jbh');?></span>
			<a href="javascript:;" data-orderby="date"><?php echo esc_html__('Published Date','17jbh');?></a>
            <a href="javascript:;" data-orderby="view"><?php echo esc_html__('Most Viewed','17jbh');?></a>
            <a href="javascript:;" data-orderby="like"><?php echo esc_html__('Most Liked','17jbh');?></a>
            <a href="javascript:;" data-orderby="comments"><?php echo esc_html__('Most Commented','17jbh');?></a>
            <a href="javascript:;" data-orderby="ratings"><?php echo esc_html__('Most Rated','17jbh');?></a>
            <a href="javascript:;" data-orderby="title"><?php echo esc_html__('Title','17jbh');?></a>
		</p>
        
        <p class="filter-item order-items">
			<span class="filter-heading"><?php echo esc_html__('Order By: ', '17jbh');?></span>
			<a href="javascript:;" data-order="DESC"><?php echo esc_html__('Descending','17jbh');?></a>
            <a href="javascript:;" data-order="ASC"><?php echo esc_html__('Ascending','17jbh');?></a>
		</p>
		
		<?php if($video_only){?>
            <p class="filter-item length-items">
                <span class="filter-heading">
                    <?php echo esc_html__('Video Length: ', '17jbh');?>
                </span>
                <a href="javascript:;" data-length="4"><?php echo esc_html__('Short (&lt; 4 mins)','17jbh');?></a>
                <a href="javascript:;" data-length="20"><?php echo esc_html__('Medium (&lt; 20 mins)','17jbh');?></a>
                <a href="javascript:;" data-length="10000"> <?php echo esc_html__('Long (&gt; 20 mins)','17jbh');?></a>
            </p>
		<?php }?>
        
        <?php if(!empty($all_tags)){?>        
            <p class="filter-item tags-items">
                <span class="filter-heading"><?php echo esc_html__('Tags: ', '17jbh');?></span>
                <?php
