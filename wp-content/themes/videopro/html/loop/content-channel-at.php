	    ...
	    <div class="entry-content">
	        <div class="primary-post-content<?php echo esc_attr($has_no_picture_class);?>"> <!--addClass: related-post, no-picture -->
	            ...
	            <div class="content">
	                ...
	                ?>
	                <div class="posted-on">
	                    <div class="videos cactus-info"><?php echo esc_html($n_video); esc_html_e(' videos', '17jbh');?></div>
	                    <div class="view cactus-info"><?php echo esc_html($view_channel); esc_html_e(' views', '17jbh');?></div>
	                </div><!--info-->
