...
<article <?php post_class('cactus-post-item ' . $has_no_picture_class);?>>
    ...
    <div class="entry-content">                                        
        ...
        <div class="content">
            ...
            <?php
            $enable_subscription = osp_get('ct_channel_settings', 'channel_subscription');
            ...
            if ($enable_subscription == '1') { ?>
                <div class="posted-on metadata-font">
                    <a href="javascript:void(0)" class="author cactus-info font-size-1"><span><?php echo sprintf(esc_html__('%d subscribers', '17jbh'), $subscribe_counter);?></span></a>
                </div>
            <?php } ?>
