...
if(function_exists('osp_get')){
	$video_more_content = osp_get('ct_viEdit
	deo_settings','video_more_content');
}
?>
<div class="body-content">
	...
	?>
	<?php edit_post_link( esc_html__( '编辑', '17jbh' ), '<span class="edit-link">', '</span>' ); ?>
</div>
<?php if($video_more_content!='off'){?>
    <div class="overlay-hidden-content"></div>
    <div class="btn-hidden-content">
        <div><span></span></div>
        <div><a href="#" class="btn btn-default ct-gradient bt-action metadata-font font-size-1 remove-hidden-content"><span><?php esc_html_e('显示更多内容','17jbh')?></span></a></div>
        <div><span></span></div>
    </div>
<?php }?>
<?php 
