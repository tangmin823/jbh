                        ...
                        <ul>                	                 
                            <li>   
                                <?php if ( !is_user_logged_in() ) { ?>                                      
                                    ...
                                    <ul>
                                        <li><a href="<?php echo esc_url($videopro_register_url);?>"><?php if($membership_register_text != '') { echo esc_html($membership_register_text); } else esc_html_e('Register','17jbh'); ?></a></li>
                                    </ul>
                                    <?php }?>
                                <?php } else {
                                ...
                                if ($user_avatar && strpos($user_avatar, 'd=blank') !== false) {
                                    ...
                                    if(has_nav_menu( 'user-menu' )){
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="<?php echo get_author_posts_url(get_current_user_id()); ?>"><?php esc_html_e('Public Profile','17jbh') ?></a></li>
                                            <?php }?>
                                            <?php
											if($mebership_logout!='off'){?>
                                                <li><a href="<?php echo wp_logout_url( videopro_get_current_url() ); ?>"><?php esc_html_e('Logout','17jbh') ?></a></li>
                                            <?php }?>
                                        </ul>
                                        <?php 
                                    }else{
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="<?php echo get_author_posts_url(get_current_user_id()); ?>"><?php esc_html_e('Public Profile','17jbh') ?></a></li>
                                            <?php }?>
                                            <li><a href="<?php echo get_edit_user_link( $current_user->ID ); ?>"><?php esc_html_e('Edit Profile','17jbh') ?></a></li>
                                            <li><a href="<?php echo wp_logout_url( videopro_get_current_url() ); ?>"><?php esc_html_e('Logout','17jbh') ?></a></li>
                                        </ul>
                                    <?php }?>
                                <?php }?>
