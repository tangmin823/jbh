                                                    ...
                                                    <div class="vp-col-inner "><div class="wpb_wrapper">
                                                        <div class="user with-name">
                                                            <div class="user-data">
                                                                ...
                                                                <span class="posts_count data"><?php echo $count < 2 ? sprintf(__('%d post','17jbh'), $count) : sprintf(__('%d posts','17jbh'), $count);?></span>
                                                                <?php 
                                                                ...
                                                                if(ot_get_option('author_page_social_accounts','on') == 'on'){
                                                                    if($facebook = get_the_author_meta('facebook',$user->ID)){
                                                                        $accounts .= '<li class="facebook"><a rel="nofollow" href="' . esc_url($facebook) . '" title="' . esc_html__('Facebook', '17jbh') . '"><i class="fab fa-facebook"></i></a></li>';
                                                                    }
                                                                    
                                                                    if($twitter = get_the_author_meta('twitter',$user->ID)){
                                                                        $accounts .= '<li class="twitter"><a rel="nofollow" href="' . esc_url($twitter) . '" title="' . esc_html__('Twitter', '17jbh') . '"><i class="fab fa-twitter"></i></a></li>';
                                                                    }
                                                                    
                                                                    if($linkedin = get_the_author_meta('linkedin',$user->ID)){
                                                                        $accounts .= '<li class="linkedin"><a rel="nofollow" href="' . esc_url($linkedin) . '" title="' . esc_html__('Linkedin', '17jbh') . '"><i class="fab fa-linkedin"></i></a></li>';
                                                                    }
                                                                    
                                                                    if($tumblr = get_the_author_meta('tumblr',$user->ID)){
                                                                        $accounts .= '<li class="tumblr"><a rel="nofollow" href="' . esc_url($tumblr) . '" title="' . esc_html__('Tumblr', '17jbh') . '"><i class="fab fa-tumblr"></i></a></li>';
                                                                    }
                                                                    
                                                                    if($google = get_the_author_meta('google',$user->ID)){
                                                                        $accounts .= '<li class="google-plus"> <a rel="nofollow" href="' . esc_url($google) . '" title="' . esc_html__('Google Plus', '17jbh') . '"><i class="fab fa-google-plus"></i></a></li>';
                                                                    }
                                                                    
                                                                    if($pinterest = get_the_author_meta('pinterest',$user->ID)){
                                                                        $accounts .= '<li class="pinterest"> <a rel="nofollow" href="' . esc_url($pinterest) . '" title="' .  esc_html__('Pinterest', '17jbh') . '"><i class="fab fa-pinterest"></i></a></li>';
                                                                    }
