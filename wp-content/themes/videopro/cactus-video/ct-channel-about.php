<div class="about-content body-content">
    ...
    <div id="channel-about-edit" style="display:none">
        <p><label><?php echo esc_html__('Channel Description:','17jbh');?></label> <textarea class="channel_description" data-channel="<?php echo get_the_ID();?>"><?php echo get_the_content();?></textarea></p>
        <a href="#" class="btn-save-channel-description" data-channel="<?php echo get_the_ID();?>"><?php echo esc_html__('Save', '17jbh');?></a><img class="ajax-loader" src="<?php echo get_template_directory_uri();?>/images/ajax-loader.gif" alt="Sending ..." style="display:none">
    </div>
