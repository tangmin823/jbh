			...
			$format = get_post_format(get_the_ID());
			  ...
			  $html .= '
					<div class="qv_tooltip"  title="
						...
						<div class= \'gv-button\'>';
							if($format == 'video'){
								$html .= '<div class=\'quick-view\'><a href='.get_permalink().' title=\''.esc_attr(get_the_title()).'\'>'.esc_html__('Watch Now','17jbh').'</a></div>';
							}else{
								$html .= '<div class=\'quick-view\'><a href='.get_permalink().' title=\''.esc_attr(get_the_title()).'\'>'.esc_html__('Read more','17jbh').'</a></div>';
							}
							$html .='
