...
class videopro_Recent_Comments extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget-popular-post widget-comment', 'description' => esc_html__( 'The most recent comments', '17jbh' ) );
		parent::__construct('ct-recent-comments', esc_html__('VideoPro - Recent Comments', '17jbh'), $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Recent Comments', '17jbh' );
						...
						<div class="entry-content">
							<div class="picture">
								<div class="picture-content">
									<a class="cm-avatar" class="post-link" target="'. apply_filters('videopro_loop_item_url_target', '_self', $comment->comment_post_ID) . '" href="' . esc_url( $link_post ) . '">
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e( 'Number of comments to show:', '17jbh' ); ?></label>
