...
class videopro_thumb_config extends videopro_config{
	...
	public static function get_all(){
		$arr_sizes = array(
				'videopro_misc_thumb_1' => array(50, 50, true, esc_html__('Thumb 50x50px', '17jbh'), esc_html__('This thumb size is used for: Channel Avatar', '17jbh')),
				'videopro_misc_thumb_2' => array(100, 75, true, esc_html__('Thumb 100x75px', '17jbh'), esc_html__('This thumb size is used for: Post Navigation Thumbnail', '17jbh')),
				'videopro_misc_thumb_3' => array(205, 115, true, esc_html__('Thumb 205x115px', '17jbh'), esc_html__('This thumb size is used for: Popular Posts Layout 3', '17jbh')),
				'videopro_misc_thumb_4' => array(277, 156, true, esc_html__('Thumb 277x156px', '17jbh'), esc_html__('This thumb size is used for: Small Carousel', '17jbh')),
				'videopro_misc_thumb_5' => array(298, 298, true, esc_html__('Thumb 298x298px', '17jbh'), esc_html__('This thumb size is used for: Channel Thumbnail in Subscribed Channels, Actor Thumbnail', '17jbh')),
				'videopro_misc_thumb_6' => array(320, 180, true, esc_html__('Thumb 320x180px', '17jbh'), esc_html__('This thumb size is used for: Post Thumbnail in More Videos Carousel', '17jbh')),
				'videopro_misc_thumb_7' => array(407, 229, true, esc_html__('Thumb 407x229px', '17jbh'), esc_html__('This thumb size is used for: Popular Posts Layout 1, Post Thumbnail', '17jbh')),
				'videopro_misc_thumb_8' => array(565, 318, true, esc_html__('Thumb 565x318px', '17jbh'), esc_html__('This thumb size is used for: Post Thumbnail in Smart Content Box layout 9, 10, 11, 15', '17jbh')),
				'videopro_misc_thumb_9' => array(636, 358, true, esc_html__('Thumb 636x358px', '17jbh'), esc_html__('This thumb size is used for: Post Thumbnail Layout 1, Channel Thumbnail', '17jbh')),
				'videopro_misc_thumb_10' => array(800, 450, true, esc_html__('Thumb 800x450px', '17jbh'), esc_html__('This thumb size is used for: Post Thumbnail in Smart Content Box layout 5, 7, 9, 10, 15', '17jbh')),
				'videopro_misc_thumb_11' => array(1280, 720, true, esc_html__('Thumb 1280x720px', '17jbh'), esc_html__('This thumb size is used for: Full-width Post Thumbnail', '17jbh'))
			);
