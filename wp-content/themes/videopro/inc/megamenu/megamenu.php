	...
	function showMenuOptions( $item_id ){
		if(ot_get_option('megamenu')=='on'){
			$this->showCustomMenuOption(
				...
				array(
					'level'    => '0',
					'title' => esc_html__( 'Select style for Menu' , '17jbh' ),
					'label' => esc_html__( 'Menu Style' , '17jbh' ),
					'type'     => 'select',
					'default' => '',
					'ops'    => array('list'=>esc_html__('List Style','17jbh'),'columns'=>esc_html__('Columns Style','17jbh'), 'preview'=>esc_html__('Preview Mode','17jbh'))
				)
			);
		}
		...
		if(ot_get_option('megamenu')=='on'){
			$this->showCustomMenuOption(
				...
				array(
					'level'	=> '1',
					'title' => esc_html__( 'Select the widget area to display' , '17jbh' ),
					'label' => esc_html__( 'Display widgets area ' , '17jbh' ),
					'type' 	=> 'select',
					'default' => '0',
					'ops'	=> $arr
				)
		...
		if(ot_get_option('megamenu')=='on'){
			$this->showCustomMenuOption(
				...
				array(
					'level'	=> '0',
					'title' => esc_html__( 'Logic to display this menu item' , '17jbh' ),
					'label' => esc_html__( 'Display Logic' , '17jbh' ),
					'type' 	=> 'select',
					'default' => '',
					'ops'	=> array('both'=>esc_html__('Always visible','17jbh'),'guest'=>esc_html__('Only Visible to Guests','17jbh'),'member'=>esc_html__('Only Visible to Members','17jbh'))
				)
			);
		}
	}
