<div class="cactus-main-menu cactus-open-search-mobile navigation-font">
	...
	<div>
		...
		<?php if($show_categories){?>
            <span class="lookin">
            <label class="screen-reader-text lookin" for="cat"><?php echo esc_html__('Look in: ','17jbh');?></label>
        ...
        <span class="searchtext">
            <input type="text" value="<?php echo esc_attr($search_word);?>" onfocus="if(this.value == '<?php echo esc_attr($default_text);?>') this.value = '';" onblur="if(this.value == '') this.value='<?php echo esc_attr($default_text);?>'" name="s" class="ss"  autocomplete="off" placeholder="<?php echo esc_attr__('Enter Keyword', '17jbh')?>"/>
            <?php if($suggestion){?>
